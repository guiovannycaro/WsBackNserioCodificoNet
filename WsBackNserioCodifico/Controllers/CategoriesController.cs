...
namespace WsBackNserioCodifico.Controllers
{
    ...
    [Route("nserio/AppAdmin/Categories/")]
    [ApiController]
    public class CategoriesController : Controller
    {

        private readonly CategoriesDaoImpl _servicio;

        public CategoriesController(CategoriesDaoImpl servicio)
        {
            _servicio = servicio;
        }
        ...
        [HttpPost("InsertarCategories")]
        public IActionResult CreateCategory(Categories datos)
        {
            try
            {
        ...
        public IActionResult UpdateCategory(Categories datos)
        {
            try
            {
        ...
        [HttpGet("BuscarCategoriesByName")]
