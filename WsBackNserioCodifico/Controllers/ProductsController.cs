...
namespace WsBackNserioCodifico.Controllers
{
    ...
    [Route("nserio/AppAdmin/Products/")]
    [ApiController]
    public class ProductsController : Controller
    {

        private readonly ProductsDaoImpl _servicio;

        public ProductsController(ProductsDaoImpl servicio)
        {
            _servicio = servicio;
        }

        [HttpGet("ListarProducts")]
        public IActionResult listaProducts()
        {
            try
            {
        ...
        [HttpPost("InsertarProducts")]
        public IActionResult CreateCategory(Products datos)
        {
            try
            {
        ...
        public IActionResult UpdateCategory(Products datos)
        {
            try
            {
